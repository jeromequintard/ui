...
export const getData = createAction(types.GET_DATA, (uid, func, path, selectionType, extensions) => ({ uid, func, path, selectionType, extensions }));
